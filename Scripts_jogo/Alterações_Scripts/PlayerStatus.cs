...
public class PlayerStatus : MonoBehaviour
{
    ...
    public int armaduraplyernivel = 5;
    ...
    public void UpdateArmaduraplyer2()
    {
      Armaduraplyer.text = "Armadura" + armaduraplayer;
    }
